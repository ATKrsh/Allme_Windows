...
def generate_manual():
    ...
    <body>
        ...
        <div class="cover">
            ...
            <div class="cover-subtitle">Product User Manual</div>
            <div class="cover-meta">
                <strong>Platform:</strong> Microsoft Windows (x64) &nbsp;|&nbsp; 
                <strong>Version:</strong> AllmeD_v36 &nbsp;|&nbsp; 
                <strong>Document Ref:</strong> ALLME-UM-V36
            </div>
        </div>
        ...
        <p>
            Welcome to <strong>Allme</strong>! Allme is a smart, friendly desktop widget that floats as a smooth circular orb on your Windows desktop. 
        ...
        <div class="info-box">
            <div class="info-title">What Allme Does For You (Summary):</div>
            <ul>
        ...
        <div class="img-container">
            ...
            <div class="img-caption">Figure 2.1: The Allme Desktop Widget (showing central core, ring sectors, icon preview, dark backdrop card, and ambient glow halo).</div>
        </div>
        ...
        <!-- SECTION 4 -->
        <h1 class="section-header">4. Complete Menu & Settings Reference</h1>
        <p>
            Right-clicking the System Tray icon or widget opens the <strong>Persistent Settings Menu</strong>:
        </p>
        ...
        <p>
            Selecting <strong>🎛️ Futuristic Dashboard</strong> launches a dedicated diagnostic panel:
        </p>
    ...
    doc.print_(printer)
    print("Ultra-compact Product User Manual updated successfully at AllmeD_v36_Product_User_Manual.pdf")
